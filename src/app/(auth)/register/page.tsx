	...
	return (
		...
		>
			<Flex
				...
				gap={24}
			>
				<CustomTitle level={1}>Criar conta</CustomTitle>

				<div>
					<CustomTitle level={3}>Opção mais simples:</CustomTitle>
					<Text type="secondary">Crie a partir da sua conta Google</Text>
				</div>
			...
			>
				<div>
					<Text type="secondary">Se preferir, crie um usuário e senha</Text>
				</div>
